...
interface ChequeDepositSlipProps {
  onClose: () => void;
}

const ChequeDepositSlip: React.FC<ChequeDepositSlipProps> = ({ onClose }) => {
  // Cheque Deposit Slip - Exact UI match
  return (
    <div className="fixed inset-0 bg-gray-100 z-50 flex flex-col">
      ...
      <div className="flex flex-1" style={{ height: "calc(100vh - 120px)" }}>
        <div className="flex-1 bg-white flex flex-col">
          ...
          <div className="bg-blue-100 px-4 py-2 border-b">
            <div className="flex items-center justify-between">
              <div className="text-sm font-bold text-blue-700">Cheque Deposit Slip</div>
              <div className="flex items-center space-x-4">
                <div className="text-sm font-medium text-gray-700">AARTI PVT LMT</div>
                <div className="text-sm font-medium text-gray-700">1-Mar-25 to 31-Mar-25</div>
              </div>
            </div>
            <div className="text-sm text-gray-700 mt-1">Ledger: SGST</div>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr>
                  ...
                  <th className="border-r border-gray-300 px-3 py-2 text-center w-32">Instrument No</th>
                  <th className="border-r border-gray-300 px-3 py-2 text-center w-32">Instrument Date</th>
        ...
        <div className="w-48 bg-blue-50 border-l border-gray-300 h-full overflow-y-auto">
          ...
          <div className="border-b border-gray-300 p-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-gray-700">F5: Cash</span>
            </div>
          </div>
          ...
          <div className="border-b border-gray-300 p-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-gray-700">F8: Incl Printed</span>
            </div>
          </div>
