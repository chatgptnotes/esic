...
interface AshokLedgerProps {
  onClose: () => void;
}

const AshokLedger: React.FC<AshokLedgerProps> = ({ onClose }) => {
  // Ashok Ledger - Exact UI match with input boxes for totals
  return (
        ...
        <div className="flex-1 bg-white flex flex-col">
          ...
          <div className="bg-blue-100 px-4 py-2 border-b">
            <div className="flex items-center justify-between">
              <div className="text-sm font-bold text-blue-700">Ledger: Ashok</div>
