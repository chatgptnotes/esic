  ...
  useEffect(() => {
    if (visitData) {
      ...
      setPatientData(prev => ({
        ...
        beneficiaryName: "", // Leave empty to avoid duplication with patient name
        relation: "SELF",
        rank: "",
        serviceNo: cleanData(patient.insurance_person_no),
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-2 h-full min-h-[400px] flex flex-col">
                      ...
                      <div className="flex gap-2 justify-center">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => setIsESICLetterDialogOpen(true)}
